  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch("/geo-data/klimatologi.json");
        ...
        setData(jsonData);
        console.log("Data loaded from local JSON file:", jsonData);
      } catch (error) {
    ...
    fetchData();
  }, [date]); // You can keep date in dependencies if you plan to filter by date later
